	...
	m_pCpu(pCpu)
{
	...
	m_ImageView = CreateImageView(m_Image, format, VK_IMAGE_ASPECT_COLOR_BIT, mipLevels, pCpu);

	TransitionImageLayout(m_Image, format, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, mipLevels, pCommandPool, pCpu);
